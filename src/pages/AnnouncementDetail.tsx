            ...
            <div className="p-8 md:p-12">
              ...
              {effectiveType === 'file' && announcement.file_url && (
                <div className="space-y-6">
                  ...
                  {announcement.file_url.toLowerCase().endsWith('.pdf') ? (
                  ...
                  ) : announcement.file_url.toLowerCase().endsWith('.doc') || announcement.file_url.toLowerCase().endsWith('.docx') ? (
                    <div className="space-y-4">
                      <div className="border border-slate-200 rounded-xl overflow-hidden">
                        <iframe
                          src={`https://view.officeapps.live.com/op/view.aspx?src=${encodeURIComponent(window.location.origin + announcement.file_url)}`}
                          className="w-full"
                          style={{ height: '80vh', minHeight: '600px' }}
                          title="Word文档预览"
                        />
